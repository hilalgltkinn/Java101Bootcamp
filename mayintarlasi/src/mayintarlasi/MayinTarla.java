...
public class MayinTarla {
	//Mayýn Tarlasýnýn Görüntüsünü Bastýran Fonksiyon
   ...
   //Tarlanýn  Görünümünü Ve Random Olarak Mayýnlarý Yerleþtiren Fonksiyon
	...
	// Oynanýþ Fonksiyonu Satýr Ve Sütün Sayýlarýný Alýp Mayýn Kontrolüne Göre true-false Deðer Döndüren  Fonksiyon
	public static boolean Oyna(boolean MayinKonum[][],char TarlaGorunum[][],Scanner Imput) {
		...
		//Önceden Girilmiþ  Konumlarýn Girilmesini Engelleyen Fonksiyon
    ...
    Scanner Imput=new Scanner (System.in);//Kullanýcýdan Deðer Alamýzý Saðlayan Class
    
    boolean [][]MayinKonum=new boolean[10][10];//	Mayýnlarýn Konumunu Tutuðumuz MultiArray
    
    char [][]TarlaGorunum=new char[10][10];//Mayýn Tarlasýnýn Görünümünü Tutan Array
    
    TarlaOlustur(MayinKonum,TarlaGorunum);//Tarlayý Oluþturan Fonksiyonun Çaðýrýldýðý Yer
